...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mainll" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1d9a2a00#;
   pragma Export (C, u00001, "mainllB");
   ...
   u00168 : constant Version_32 := 16#f9e6a9a4#;
