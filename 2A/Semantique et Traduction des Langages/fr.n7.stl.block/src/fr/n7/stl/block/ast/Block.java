...
public class Block {
	...
	public boolean collect(HierarchicalScope<Declaration> _scope) {
		boolean ok = true;
		newTb = new SymbolTable(_scope);
		for(Instruction i : this.instructions) {
			ok = ok && i.collectAndBackwardResolve(newTb);
		}
		return ok;
	}
...
//		Fragment flag = _factory.createFragment();
//		for (Instruction instruction : this.instructions) {
//			if (instruction instanceof FunctionDeclaration) {
//				//Block.functions.add(instruction);
//				flag.append(instruction.getCode(_factory));
//			} else {
//				flag.append(instruction.getCode(_factory));
//			}
//		}
////		for (Instruction fd : this.functions) {
////			flag.append(fd.getCode(_factory));
////		}
//		return flag;
	}
