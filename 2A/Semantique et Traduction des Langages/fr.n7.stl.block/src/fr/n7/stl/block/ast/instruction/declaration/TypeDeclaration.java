...
//		/*boolean b1 = !_scope.contains(name);
//        boolean b2 = this.getType().resolve(_scope);
//        if (!b1) {
//            Logger.error("Type declaration failed");
//        } else {
...
//		}
	...
	public boolean checkType() {
		return true;
		/*Type _result = this.type.compatibleWith()
