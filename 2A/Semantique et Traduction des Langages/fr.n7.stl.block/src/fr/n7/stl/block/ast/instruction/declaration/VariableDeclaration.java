...
public class VariableDeclaration implements Declaration, Instruction {
	...
	// Ajout ( pour ne pas modifier offset et getOffset() )
	public static int namedOffset; 
...
//			return res;
//		} else {
//			Logger.error("Variable Declaration Error");
//			return false;
//		}
...
//		boolean etat = this.value.fullResolve(_scope);
//		if (!etat) {
//			System.out.println("Erreur false in VariableDeclaration.fullResolve");
//		}
//		return etat;
...
//		System.out.println("type decl : " + this.type);
//		System.out.println("valeur decl : " + value);
//		System.out.println("valeur decl type : " + value.getType());

		if ( this.value.getType().compatibleWith(this.type) || (this.type.compatibleWith(this.value.getType()))) {
			System.out.println("***************************************************");
			System.out.println("valeur : " + value);
			return true;
		} else {
			System.out.println("valeur2 : " + value);
			System.out.println("type : " + this.type);
			System.out.println("valeur2type : " + value.getType());
			Logger.error("Variable type failed!");
			return false;
		}

//		boolean compatible = this.value.getType().compatibleWith(this.type);
//		System.out.println("value : " + value + " type : " + this.value.getType() + " this.type : "+ this.type);
//		if (!compatible) {
//			System.out.println("Erreur false in VariableDeclaration.checkType");
//		}
//		return compatible;
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		// AJout pour FieldAssignement (namedTypeOffset)
		if (this.type instanceof NamedType) {
			VariableDeclaration.namedOffset = this.offset;	
		}
