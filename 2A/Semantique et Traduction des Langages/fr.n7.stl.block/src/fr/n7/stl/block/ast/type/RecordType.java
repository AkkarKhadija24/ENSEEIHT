...
public class RecordType implements Type, Declaration, Scope<FieldDeclaration> {
	...
	public RecordType(String _name, Iterable<FieldDeclaration> _fields) {
		...
		this.name = _name;
		System.out.println("fields names 1 : " + name);
	...
	public boolean compatibleWith(Type _other) {
		//System.out.println("record type compatiblewith" + _other + this);
		//throw new SemanticsUndefinedException( "compatibleWith is undefined in RecordType.");
//		if (_other instanceof RecordType) {
//			boolean ok = true;
//			RecordType record = (RecordType) _other;
//			List<FieldDeclaration> fieldsOthers = record.fields;
//			 if (this.fields.size() == fieldsOthers.size()) {
//		            for (int i = 0; i < this.fields.size(); i++) {
//		                FieldDeclaration thisField = this.fields.get(i);
//		                FieldDeclaration otherField = fieldsOthers.get(i);
//		                if (!thisField.getType().compatibleWith(otherField.getType())) {
//		                    return false;
//		                }
//		            }
//		            return true;
...
//		System.out.println("fields names : " + this.name);
//		System.out.println("fields : " + this.fields);
//		boolean _result = true;
//		if (_scope.contains(this.getName())) {
//			_result = false;
//			Logger.error("Record Type resolve failed");
//		} else {
//			_scope.register(this);
//			HierarchicalScope<Declaration> n_scope = new SymbolTable(_scope);
//			for (FieldDeclaration f : this.fields) {
//				_result = _result && f.getType().resolve(n_scope);
//			}
//		}
//		return _result;
